            ...
            <td>{{ $usuario->email }}</td>
                <td>
                    ...
                    <div class='btn-group'>
                        ...
                        {!! Form::button('<i class="glyphicon glyphicon-trash"></i>', ['type' => 'submit', 'class' => 'btn btn-danger btn-xs', 'onclick' => "return confirm('Tem certeza que deseja deletar este usuário?')"]) !!}
                    </div>
                    {!! Form::close() !!}
                </td>
            </tr>
